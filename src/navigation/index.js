    ...
    if (isLogin === null) {
        return (
            <Fragment>
                ...
                <View style={{ backgroundColor: colors?.background?.main, flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ gap: 25 }}>
                        <ActivityIndicator size={'large'} color={colors?.primary?.main} />
                        <Text style={{ ...FontStyle(colors?.common?.black, 14, 500) }}>
        ...
        <Fragment>
            ...
            >
                <View style={{ display: "flex", alignItems: "center", flexDirection: "row", gap: 20, }}>
                    <Text style={{ ...FontStyle(colors?.common?.white, 14, 700,), flex: 1 }}>{message}</Text>
                    <TouchableOpacity onPress={() => onDismissSnackBar()}>
                        <Text style={{ ...FontStyle(colors?.common?.white, 14, 700), }}>Dismiss</Text>
                    </TouchableOpacity>
                </View>
            </Snackbar>
        </Fragment>
