...
const TextInput = ({ onPress, startIcon, endIcon, placeholder, placeholderTextColor, onChangeText, value, editable, inputMode, keyboardType, onPressIn, readOnly, secureTextEntry, maxLength, autoCapitalize, autoComplete, autoFocus }) => {
    ...
    return (
        <Fragment>
            <Pressable onPress={onPress} style={{ display: "flex", flexDirection: "row", alignItems: "center", paddingVertical: 10, paddingHorizontal: 10, borderWidth: 1, borderStyle: "solid", borderRadius: shape?.borderRadius, borderColor: colors?.primary?.blueGrey?.[100], flex: 1, }}>
